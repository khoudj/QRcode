		...
		<form role="form" action="<?=BASE_URL.DS.'pages'.DS?>generateqrcode/" method="GET">
		  <div class="form-group">
			<label for="titre">Ton titre</label>
		  	<input type="titre" class="form-control" placeholder="ton titre" name="titre" required />
		  ...
		  <p>Génère ou enregistre ton QR CODE</p>
	  	  <div class="input-group">
			      ...
			      <label for="qrtypeSauv">Sauvegarder </label> <input type="radio" name="qrtype" id="qrtypeSauv" value="record" /> >>
