...
<?php 
	...
	foreach($myqrcode as $value){
		...
		<div class="row">
			    <div class="col-lg-6">
					<img src="<?php echo BASE_URL.DS.'img'.DS.'qrcode.php?msg='.base64_encode($value->message); ?>" alt="QR CODE généré" />
				</div>
				<div class="col-lg-6">
					<div class="form-group">
			 		...
			 		<p><a class="btn btn-danger btn-small" href="<?=BASE_URL.DS?>myqrcode/supprimerqrcode/<?=$value->id?>">Supprimer [X]</a></p>
		 		</div>
		</div>
		<hr/>
		<?php
